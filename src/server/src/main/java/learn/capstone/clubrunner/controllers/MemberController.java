...
public class MemberController {
    ...
    @GetMapping("/{runId}")
    public Member findById(@PathVariable int memberId) {return service.findById(memberId);}

    @GetMapping("/{userId}")
    public Member findByUserId(@PathVariable int userId) {return service.findByUserId(userId);}

    @GetMapping("/{clubId}")
    public Member findByClubId(@PathVariable int clubId) {return service.findByClubId(clubId);}
